...
export const testimonials: Testimonial[] = [
  { id: "1", name: "Sarah Johnson", text: "The freshest produce I've ever had delivered. The quality is consistently outstanding, and the organic options are wonderful!", rating: 5, avatar: "SJ" },
  { id: "2", name: "Mike Chen", text: "Love the bakery section! The sourdough bread is incredible, and the pastries are always fresh. Best grocery shop in town.", rating: 5, avatar: "MC" },
  { id: "3", name: "Emily Davis", text: "Amazing variety and unbeatable prices. The customer service is exceptional — they always go above and beyond.", rating: 4, avatar: "ED" },
];
